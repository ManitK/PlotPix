...
def get_image(model,movie,plot):
    ...
    instruction = "Do not add any text or words in the image generated. The image should be a depiction of the following prompt: "
    ...
    img_loc = "/Users/manitk/Desktop/Project/data/"
...
images_data = {}
plots_file = '/Users/manitk/Desktop/Project/generate-data/movie_plots.json'
...
for genre in plots_data:
    ...
    for movie in plots_data[genre]:
        ...
        images_data[genre][movie] = {'plot': plot, 'dalle_3_img': dalle_3_img}

output_file = '/Users/manitk/Desktop/Project/generate-data/movie_images.json'
with open(output_file, 'w') as f:
    json.dump(images_data, f, indent=4)

# dalle_3_img = get_image(3,"The Shawshank Redemption","A banker convicted of uxoricide forms a friendship over a quarter century with a hardened convict, while maintaining his innocence and trying to remain hopeful through simple compassion.")